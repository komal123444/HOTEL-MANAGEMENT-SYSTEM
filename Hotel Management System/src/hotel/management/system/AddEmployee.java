...
public class AddEmployee extends JFrame implements ActionListener{
        JTextField tfname,tfphone,tfage,tfemail,tfsalary,tfaadhar;
    ...
    rbfemale.setBackground(Color.WHITE);
      ...
      bg.add(rbfemale);
        ...
        add(lbljob);
        String str[]={"Front Desk Clerks","Porters","HouseKepping","Kitechen Staff","Room Service","Chefs","Waiter/Waitress","Manager","Accountant"};
